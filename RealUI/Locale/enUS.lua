...
L["Appearance_SkipWorldMapSkinDesc"] = "Workaround for a Blizzard taint bug: disables Aurora's World Map skin to prevent SetPassThroughButtons ADDON_ACTION_BLOCKED errors on map pins.\n\nCoordinate display will still work. Requires reload."
