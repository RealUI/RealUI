...
L["Appearance_SkipWorldMapSkin"] = "Disable World Map Skin"
L["Appearance_SkipWorldMapSkinDesc"] = "Workaround for a Blizzard taint bug: disables the World Map skin to prevent SetPassThroughButtons ADDON_ACTION_BLOCKED errors on map pins.\n\nCoordinate display will still work. Requires reload."
...
L["CombatText_Summary"] = "%s (%d hits, %d crits)"
L["CombatText_SummaryNoCrit"] = "%s (%d hits)"
L["CombatText_SummaryCat_Damage"] = "Damage"
L["CombatText_SummaryCat_Healing"] = "Healing"
L["CombatText_SummaryCat_Miss"] = "Avoided"
...
L["Currency_TotalMoney_Account"] = "Total account money: "
...
L["HuD_VerticalActionBarDesc"] = "Adjust the vertical position of the top center action bars. Bottom bars remain anchored above the Infobar."
L["HuD_Width"] = "Width"
L["Infobar"] = "Infobar"
...
L["Infobar_HideStatusBarMaxLevel"] = "Hide status bars at max level"
L["Infobar_HideStatusBarMaxLevelDesc"] = "Hide the progress watch status bars at max level."
...
L["Inventory_UnknownFilter"] = "Unknown filter: "
...
L["Layout_LinkDesc"] = "Use same settings between DPS/Tank and Healing layouts.\n\n|cffffcc00Account-wide:|r this setting applies to every character, because the two layout profiles it writes through are shared by all of them. |cff808080/realui resetchar|r does not clear it."
L["HuD_Reattach"] = "Re-attach elements to sliders"
L["HuD_ReattachDesc"] = "Elements you have dragged by hand stop following the Vertical and Anchor Width sliders — they keep the position you dropped them at instead. This clears those hand positions for the current layout so the sliders control them again.\n\nCast bars and class resources pinned to a unit frame are not affected, and neither are the party/raid anchors."
...
L["Layout_LinkNoteBars"] = "|cffffcc00Link Layouts is on|r|cff808080 — moving this slider moves the bars in both the DPS/Tank and Healing layouts. The two saved numbers will differ, because each layout measures from its own baseline, but the bars land in the same place on screen. Turn it off in HuD → General to set them separately.|r"
...
L["Sys_PerformanceMonitorEnabled"] = "Performance Monitor Enabled"
L["Sys_PerformanceMonitorEnabledDesc"] = "Enable performance monitoring. May add overhead on some computers."
...
L["Progress_OpenHousing"] = "<Click> Open housing list"
...
L["UnitFrames_AuraLayoutBuffAnchor"] = "Buff Position"
L["UnitFrames_AuraLayoutBuffAnchorDesc"] = "Where buffs start from on the unit frame"
L["UnitFrames_AuraLayoutBuffGrowthX"] = "Buff Growth (Horizontal)"
L["UnitFrames_AuraLayoutBuffGrowthXDesc"] = "Direction buffs grow horizontally"
L["UnitFrames_AuraLayoutBuffGrowthY"] = "Buff Growth (Vertical)"
L["UnitFrames_AuraLayoutBuffGrowthYDesc"] = "Direction buffs grow vertically"
L["UnitFrames_AuraLayoutBuffMaxWidth"] = "Buff Max Width"
L["UnitFrames_AuraLayoutBuffMaxWidthDesc"] = "Maximum width for buff area (0 = unlimited/frame width)"
L["UnitFrames_AuraLayoutDebuffAnchor"] = "Debuff Position"
L["UnitFrames_AuraLayoutDebuffAnchorDesc"] = "Where debuffs start from on the unit frame"
L["UnitFrames_AuraLayoutDebuffGrowthX"] = "Debuff Growth (Horizontal)"
L["UnitFrames_AuraLayoutDebuffGrowthXDesc"] = "Direction debuffs grow horizontally"
L["UnitFrames_AuraLayoutDebuffGrowthY"] = "Debuff Growth (Vertical)"
L["UnitFrames_AuraLayoutDebuffGrowthYDesc"] = "Direction debuffs grow vertically"
L["UnitFrames_AuraLayoutDebuffMaxWidth"] = "Debuff Max Width"
L["UnitFrames_AuraLayoutDebuffMaxWidthDesc"] = "Maximum width for debuff area (0 = unlimited/frame width)"
L["UnitFrames_BuffCount"] = "Buff Count"
L["UnitFrames_BuffSize"] = "Buff Size"
L["UnitFrames_DebuffCount"] = "Debuff Count"
L["UnitFrames_DebuffSize"] = "Debuff Size"
...
L["UnitFrames_ReverseFill"] = "Reverse fill direction"
L["UnitFrames_ReverseFillDesc"] = "Reverse the fill direction of the player unit frame bars."
L["UnitFrames_ReversePercent"] = "Reverse percent"
L["UnitFrames_ReversePercentDesc"] = "Invert the fill percent for the player unit frame bars."
