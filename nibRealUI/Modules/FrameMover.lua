    ...
    self.db:RegisterDefaults({
        profile = {
            addons = {
                ...
                raven = {
                    frames = {
                        [1] = {name = "RavenBarGroupPlayerBuffs",   parent = "RealUIPlayerFrame",       point = "TOPRIGHT",    rpoint = "TOPLEFT",  x = -15, y = 3},
                        [2] = {name = "RavenBarGroupPlayerDebuffs", parent = "RealUIPlayerFrame",       point = "BOTTOMRIGHT", rpoint = "TOPLEFT",  x = -15, y = 3},
                        [3] = {name = "RavenBarGroupTargetBuffs",   parent = "RealUITargetFrame",       point = "TOPLEFT",     rpoint = "TOPRIGHT", x = 15,  y = 3},
                        [4] = {name = "RavenBarGroupTargetDebuffs", parent = "RealUITargetFrame",       point = "BOTTOMLEFT",  rpoint = "TOPRIGHT", x = 16,  y = 3},
                        [5] = {name = "RavenBarGroupFocusBuffs",    parent = "RealUIFocusFrame",        point = "TOPRIGHT",    rpoint = "TOPLEFT",  x = -14, y = 5},
                        [6] = {name = "RavenBarGroupFocusDebuffs",  parent = "RealUIFocusFrame",        point = "TOPRIGHT",    rpoint = "TOPLEFT",  x = -14, y = -21},
                        [7] = {name = "RavenBarGroupToTDebuffs",    parent = "RealUITargetTargetFrame", point = "TOPLEFT",     rpoint = "TOPRIGHT", x = 14,  y = 5},
                    },
                },
            },
            uiframes = {
