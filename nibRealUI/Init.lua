...
for specIndex = 1, RealUI.GetNumSpecializationsForClassID(classID) do
    local id, name, _, iconID, role, isRecommended = RealUI.GetSpecializationInfoForClassID(classID, specIndex)
