...
function cbNivaya:ClassifyItem(item)
    ...
    elseif item.typeID then
        ...
        elseif (item.typeID == _G.LE_ITEM_CLASS_TRADEGOODS) then
            ...
            elseif item.subTypeID == 5 and cbNivaya:CheckTable(bags,"Tradeskill: Cloth") then
                itemClass[item.id] = "Tradeskill: Cloth"
            elseif item.subTypeID == 6 and cbNivaya:CheckTable(bags,"Tradeskill: Leathworking") then
                itemClass[item.id] = "Tradeskill: Leatherworking"
            elseif item.subTypeID == 7 and cbNivaya:CheckTable(bags,"Tradeskill: Metal & Stone") then
                itemClass[item.id] = "Tradeskill: Metal & Stone"
            elseif item.subTypeID == 8 and cbNivaya:CheckTable(bags,"Tradeskill: Cooking") then
                itemClass[item.id] = "Tradeskill: Cooking"
            elseif item.subTypeID == 9 and cbNivaya:CheckTable(bags,"Tradeskill: Herb") then
                itemClass[item.id] = "Tradeskill: Herb"
            elseif item.subTypeID == 10 and cbNivaya:CheckTable(bags,"Tradeskill: Elemental") then
                itemClass[item.id] = "Tradeskill: Elemental"
            elseif item.subTypeID == 12 and cbNivaya:CheckTable(bags,"Tradeskill: Enchanting") then
                itemClass[item.id] = "Tradeskill: Enchanting"
            elseif item.subTypeID == 16 and cbNivaya:CheckTable(bags,"Tradeskill: Inscription") then
