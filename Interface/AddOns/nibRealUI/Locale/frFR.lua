...
L["General_Lock"] = "Verrouillé" -- Needs review
L["General_LockDesc"] = "activer pour déplacer ou verrouiller la position du cadre" -- Needs review
...
-- L["Progress_OpenRep"] = ""
L["Spec_ChangeSpec"] = "<Spec Click> pour changer la spécialisation de talent" -- Needs review
-- L["Spec_EquipCycle"] = ""
L["Spec_EquipUnassign"] = "<Équiper Shift+Click> pour désassigner" -- Needs review
