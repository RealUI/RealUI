...
L["General_LoadDefaults"] = "载入默认设置" -- Needs review
...
L["HuD_MouseWheelSliders"] = "（可以使用鼠标滚轮来精确地调整滑块）" -- Needs review
...
L["Raid_ControlLayout"] = "允许RealUI控制%s的布局设置"
L["Raid_ControlPosition"] = "允许RealUI控制%s的位置" -- Needs review
L["Raid_ControlStyle"] = "允许RealUI改变%s外观（需要重载UI：/rl）"
