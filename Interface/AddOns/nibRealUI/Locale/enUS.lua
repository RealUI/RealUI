...
L["Scale_HighRes"] = "High Resolution"
L["Scale_HighResDesc"] = "This will double the current UI Scale to make interface elements easier to see.\n\nNote: This is only recommended when using a display with a vertical resolution of 1440 px or larger."
L["Scale_Pixel"] = "Pixel Perfect"
L["Scale_PixelDesc"] = "Sets the scale of the UI so that an in-game pixel matches your physical screen's pixels."
