...
L["Tweaks_HideRaidFilter"] = "Скрыть фильтры рейдов"
L["Tweaks_HideRaidFilterDesc"] = "Скрыть фильтры групп для стандартных рамок рейда"
...
L["AuraTrack_InvalidName"] = "Название заклинания или ID не найден."
-- L["AuraTrack_Lock"] = ""
