...
L["AuraTrack_InvalidName"] = "Неверное название заклинания или ID: %s"
...
L["Progress"] = "Следить"
L["Progress_Cycle"] = "<Alt+ЛКМ> для смены отображения" -- Needs review
L["Progress_OpenArt"] = "<ЛКМ> для просмотра артефакта" -- Needs review
L["Progress_OpenHonor"] = "<ЛКМ> для просмотра Чести" -- Needs review
L["Progress_OpenRep"] = "<ЛКМ> для просмотра Репутации" -- Needs review
L["Spec_ChangeSpec"] = "<ЛКМ> для смены специализации."
L["Spec_EquipCycle"] = "<Alt+ЛКМ> для смены наборов экипировки"
L["Spec_EquipUnassign"] = "<Shift+ЛКМ> что бы отменить назначение."
