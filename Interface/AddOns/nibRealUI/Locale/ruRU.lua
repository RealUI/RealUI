...
L["General_Lock"] = "Заблокировать" -- Needs review
L["General_LockDesc"] = "Переключите для передвижения или блокировки позиции окна." -- Needs review
...
-- L["Spec_EquipCycle"] = ""
L["Spec_EquipUnassign"] = "<Shift над экипировкой+ЛКМ> что бы отменить назначение." -- Needs review
