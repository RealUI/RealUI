    ...
    self.db:RegisterDefaults({
        profile = {
            addons = {
                ...
                raven = {
                    frames = {
                        [1] = {name = "RavenBarGroupPlayerBuffs",   parent = "RealUIPlayerFrame",       point = "LEFT",        rpoint = "LEFT",     x = -40, y = 0.5},
                        [2] = {name = "RavenBarGroupPlayerDebuffs", parent = "RealUIPlayerShields",     point = "BOTTOMRIGHT", rpoint = "TOPRIGHT", x = 6,   y = -3},
                        [3] = {name = "RavenBarGroupTargetBuffs",   parent = "RealUITargetFrame",       point = "RIGHT",       rpoint = "RIGHT",    x = 40,  y = 0.5},
                        [4] = {name = "RavenBarGroupTargetDebuffs", parent = "RealUITargetFrame",       point = "BOTTOMLEFT",  rpoint = "TOPRIGHT", x = 6,   y = 5},
                        [5] = {name = "RavenBarGroupFocusBuffs",    parent = "RealUIFocusFrame",        point = "LEFT",        rpoint = "LEFT",     x = -40, y = -5.5},
                        [6] = {name = "RavenBarGroupFocusDebuffs",  parent = "RealUIFocusFrame",        point = "LEFT",        rpoint = "LEFT",     x = -40, y = -31.5},
                        [7] = {name = "RavenBarGroupToTDebuffs",    parent = "RealUITargetTargetFrame", point = "RIGHT",       rpoint = "RIGHT",    x = 40,  y = -5.5},
                    },
                },
            },
            uiframes = {
