...
local function CreateRDOptions()
    ...
    RDF:SetFrameLevel(0)
    _G.Aurora.Base.SetBackdrop(RDF, _G.Aurora.Color.frame:GetRGBA())
    ...
    RDF.accept.text = RDF.accept:CreateFontString(nil, "OVERLAY")
        ...
        RDF.accept.text:SetFont("SystemFont_Shadow_Med1")
    ...
    RDF.cancel.text = RDF.cancel:CreateFontString(nil, "OVERLAY")
        ...
        RDF.cancel.text:SetFontObject("SystemFont_Shadow_Med1")
